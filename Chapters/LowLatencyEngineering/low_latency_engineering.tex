...
to that job. Interview line: sleep = jitter; busy poll = latency for watts and opportunity cost.
...
\newline
Interview line: know which axis you are on. Techniques that maximize packets/sec 
