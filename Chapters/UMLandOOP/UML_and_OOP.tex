...
\section{UML}
   %% Class Diagram
    ...
    \begin{figure}[h!t]%
        ...
        \label{fig:sd-lifelines}%
    \end{figure}    
    %~ \subsubsection{Execution Occurrence}
    
    %~ \nparagraph{Self Message}
    %~ \begin{figure}[h!t]
        %~ \centering
        %~ \includegraphics[scale=0.5]{OOPandUML/SequenceDiagram/sd_recursion}
        %~ \caption{foo}
        %~ \label{fig:}
    %~ \end{figure}
    
    %~ \nparagraph{Lost and Found Messages}
    %~ \begin{figure}[h!t]
        %~ \centering
        %~ \includegraphics[scale=0.5]{OOPandUML/SequenceDiagram/sd_lost_and_found}
        %~ \caption{foo}
        %~ \label{fig:}
    %~ \end{figure}
	...
	\vspace{-\baselineskip} % Required for vertically aligning minipages
        \centering
        \includegraphics[scale=0.5]{OOPandUML/SequenceDiagram/sd_start_and_end}
        \captionof{figure}{Object-Lifetime Start and End}
    ...
    \newline
    The available fragment are listed in table~\ref{tab:sd-fragments}. 
    \end{minipage}
    ...
    \subsubsection{State Invariant / Covariant}
    \begin{minipage}[t]{0.4\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
    %~ \begin{figure}[h!t]
        \centering
