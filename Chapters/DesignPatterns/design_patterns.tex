...
rewrite hot to with bullet list for every pattern
...
\section{Creational Patterns}
    ...
    \begin{table}[h!t]
        \begin{center}
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \multirow{1}{*}{\textbf{What for}} & creating objects without  
                                                     specifying the exact class 
                                                     of the object\\
                \hline
                \multirow{1}{*}{\textbf{How to}} & a \highlightit{factory method} 
                                                   is used \highlightit{instead of calling a constructor} \\

                \hline
                \textbf{When needed} & $\bullet$ the exact types and dependencies 
                                       of the objects is unknown \\
                                     & \quad beforehand \\
    ...
    \begin{table}[h!t]
        ...
        \begin{figure}[H]
            \begin{center}
            %~ \include{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/builder_design_pattern.tex}
                \include{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/factory_method_design_pattern.tex}
            \end{center}
        \end{figure}
        \endgroup
        \vspace{-1cm}
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \highlightbf{ABCProduct} & the interface common to all 
                                           the objects. \\
                \hline
                \highlightbf{ProductA}, \highlightbf{ProductB} & the different implementations 
                                                                 of the previous interface. \\
                \hline
                \highlightbf{ABCCreator} & the base class which declares 
                                           the factory method: \\
                                         ...
                                         & It can have some \highlightit{core business logic} 
                                           which can be split from the 
                                           product creation. \\
                \hline
                \highlightbf{CreatorA},  & the concrete classes that \highlightit{override the base factory method} \\
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & families of related items 
                                                 without specifying their 
                                                 concrete classes\\
            \hline
            \multirow{1}{*}{\textbf{How to}} & explicit interfaces for 
                                               each distinct product of 
                                               the product family,\\
                                             & implemented and followed 
                                               by all variants of products\\
            \hline
            ...
            \end{tabularx}
    \end{table}
    %%% rephrase better into previous table
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \include{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/abstract_factory_design_pattern.tex}
        \end{figure}
        \endgroup
        \vspace{-1cm}
        \begin{tabularx}{\textwidth}{|l|X|}
            ...
            \hline
            \highlightbf{ProductA1}, \dots , \highlightbf{ProductB2} & implementations of the concrete variants of abstract products.
            ...
            \hline
            \highlightbf{Factory1}, \highlightbf{Factory2} & implement the creation methods of the abstract factory,
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Pros} & $\bullet$\, interchangeable concrete implementations 
                            without changing the code that \\
                          & \quad uses them\\
                          & $\bullet$\, no tight coupling between concrete 
                            products and client code\\
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & building complex objects 
                                                 step-by-step, producing 
                                                 different types and 
                                                 representations using 
                                                 the same construction 
                                                 steps\\
            \hline
            \multirow{1}{*}{\textbf{How to}} & object's construction code 
                                               is moved into a 
                                               \highlightit{Builder} class, 
                                               that build the object through 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/builder_design_pattern.tex} 
        \end{figure}
        \endgroup
        \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & copying existing objects 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/prototype_design_pattern.tex}        
        \end{figure}
        \endgroup
        \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & ensuring that a class could have one instance only, \\
                                               & while providing a global access point to the instance \\
            \hline
            \multirow{1}{*}{\textbf{How to}} & the ctor is made private to prevent calls from outside the class \\
                                             & and a static creation method is used in its place in order to create \\
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
        \input{./Chapters/DesignPatterns/TikzInclude/TikzCreationalPatterns/singleton_design_pattern.tex}    
        \end{figure}
        \endgroup
        \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Pros} & $\bullet$ avoiding global namespace pollution introducing global variables \\
                          & $\bullet$ initialization takes place only the first time the object is requested\\
                          & $\bullet$ multiple but limited instances can be created, modifing only the static\\
                          & \quad method\\
            \hline
...
\section{Behavioral Patterns}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & pass a request along a 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
        \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/chain_of_responsibility_design_pattern.tex}       
        \end{figure}
        \endgroup
        \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & turning a request into a 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
        \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/command_design_pattern.tex}   
        \end{figure}
        \endgroup
    \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & enabling users to traverse 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/iterator_design_pattern.tex}       
        \end{figure}
        \endgroup
        \vspace{-0.5cm}
        \begin{tabularx}{\textwidth}{|l|X|}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & reducing chaotic and 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/mediator_design_pattern.tex}       
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{ABCComponent} & \\
            \hline
            \highlightbf{ComponentA}, \dots, & \\
            \highlightbf{ComponentC} & \\
            \hline
            \highlightbf{ABCMediator} & \\
            \hline
            \highlightbf{MediatorA} & \\
            \hline
        \end{tabularx}    
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & saving/restoring 
                                                 states of an object 
                                                 without exposing 
                                                 internals\\
            \hline
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/memento_design_pattern.tex}
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & implementing a subscription mechanism\\
            \hline
            \multirow{1}{*}{\textbf{How to}} & \\
            \hline
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
        \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/observer_design_pattern.tex}
    \end{figure}
    \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{Publisher} & \\
            \hline
            \highlightbf{ABCSubscriber} & \\
            \hline
            \highlightbf{SubscriberA}, \highlightbf{SubscriberB} & \\
            \hline
            \highlightbf{Client} & \\
            \hline
        \end{tabularx}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & implementing objects whose 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/state_design_pattern.tex}        
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & defining a family of 
                                                 algorithms, each 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/strategy_design_pattern.tex}        
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            ...
            \hline
            \highlightbf{ABCStrategy} & \\
            \hline
            \highlightbf{StrategyA}, \highlightbf{StrategyB} & \\
            \hline
            \highlightbf{Client} & \\
            \hline
        \end{tabularx}    
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & defining the skeleton of 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/template_design_pattern.tex}        
        \end{figure}
    %~ \begin{itemize}
    ...
    %~ \end{itemize}
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{ABCClass} & \\
            \hline
            \highlightbf{ClassA}, \highlightbf{ClassB} & \\
            \hline
        \end{tabularx}    
        \caption{Strategy Class Diagram.}
        \label{tab:strategy-class-diagram}     
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & separating algorithms 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzBehavioralPatterns/visitor_design_pattern.tex}      
        \end{figure}
        \endgroup
    %~ \begin{itemize}
    ...
    %~ \end{itemize}
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{ABCVisitor} & \\
            \hline
            \highlightbf{VisitorA}, \highlightbf{VisitorB} & \\
            \hline
            \highlightbf{ABCElement} & \\
            \hline
            \highlightbf{ElementA}, \highlightbf{ElementB} & \\
            \hline
            \highlightbf{Client} & \\
            \hline
        \end{tabularx}    
...
\section{Structural Patterns}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & allowing objects with 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
        \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/adapter_design_pattern.tex}      
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & splitting a large class 
            or a set of related classes into an abstracion and an implementation 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/bridge_design_pattern.tex}
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{Abstraction} & \\
            \hline
            \highlightbf{RefinedAbstraction} & \\
            \hline
            \highlightbf{ABCImplementation} & \\
            \hline
            \highlightbf{ImplementationA}, &  \\
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            ...
            \highlightbf{Adapter} &  \\
            \hline
            \highlightbf{State}, \highlightbf{Strategy} &  \\
            \hline
            \highlightbf{Abstract Factory} &  \\
            \hline
            \highlightbf{Builder} &  \\
            \hline      
        \end{tabularx}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & composing objects into 
                                                 tree structures in order to 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \include{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/composite_design_pattern.tex}       
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & attach new behaviors to 
                                                 objects \\
            \hline
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/decorator_design_pattern.tex}      
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{ABCComponent} & \\
            \hline
            \highlightbf{ComponentA} & \\
            \hline
            \highlightbf{ABCDecorator} & \\
            \hline
            \highlightbf{DecoratorA},  & \\
            \highlightbf{DecoratorB}   & \\
            \hline
        \end{tabularx}    
    ...
    \toclessnparagraph{Relation with other Design Patterns}    
     \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            ...
            \highlightbf{Adapter} &  \\
            \hline
            \highlightbf{Chain of Responsibility} &  \\
            \hline
            \highlightbf{Composite} &  \\
            \hline
            \highlightbf{Prototype} &  \\
            \hline
            \highlightbf{Startegy} &  \\
            \hline
            \highlightbf{Proxy} &  \\
            \hline
        \end{tabularx}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & providing users with a simplified 
                                                 interface to any complex set of classes\\
            \hline
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/facade_design_pattern.tex}       
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \highlightbf{Facade} & \\
            \hline
            \highlightbf{AdditionalFacade} & \\
            \hline
            \highlightbf{SubSystemA}, \dots, & \\
            \highlightbf{SubSystemC} & \\
            \hline
            \highlightbf{AdditionalSubSys} & \\
            \hline
        \end{tabularx}    
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/flyweight_design_pattern.tex}      
        \end{figure}
        \endgroup
    %~ \begin{itemize}
    ...
    \begin{table}[h!t]
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \multirow{1}{*}{\textbf{What for}} & providing a substitute 
                                                 or placeholder for another 
                                                 object, and controlling 
    ...
    \begin{table}[h!t]
        ...
        \begingroup
        \begin{figure}[H]
            \input{./Chapters/DesignPatterns/TikzInclude/TikzStructuralPatterns/proxy_design_pattern.tex}       
        \end{figure}
        \endgroup
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
