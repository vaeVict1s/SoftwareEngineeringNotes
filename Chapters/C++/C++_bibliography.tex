%%%
    ...
    %% %% 1
    %% %%
    \bibitem{fluentc++-mostvexparse}Boccara - \emph{The Most Vexing Parse: How to Spot It and Fix It Quickly}
    \newline
    ...
    %% %%
    \bibitem{wiki-most-vexing-part} \emph{Most vexing parse}
    \newline
    Retrieved from: \href{https://en.wikipedia.org/wiki/Most_vexing_parse}{WikiPedia}
