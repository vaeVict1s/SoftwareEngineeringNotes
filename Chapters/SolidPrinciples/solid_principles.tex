...
American software engineer and instructor \textbf{Robert C. Martin},[1][2][3]. \\
They were first introduced in his 2000 paper Design Principles and Design Patterns, 
while the acronym was introduced later, around 2004, by \textbf{Michael Feathers}. \\
...
\subsection{Liskov Substitution}
    ...
    See also: \url{https://en.wikipedia.org/wiki/Design_by_contract} 
