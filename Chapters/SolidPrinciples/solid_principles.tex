...
American software engineer and instructor \textbf{Robert C. Martin},~\cite{martin-poO}-~\cite{martin-SOLIDstart}-~\cite{metz-sood}. \\
They were first introduced in his 2000 paper Design Principles and Design Patterns, 
while the acronym was introduced later, around 2004, by \textbf{Michael Feathers}~\cite{feathers-clean-architecture}. \\
