...
\href{https://en.cppreference.com/w/cpp/memory}{Smart pointers} enable 
automatic, exception-safe, object lifetime management.
\newline
...
\subsubsection{\texttt{std::unique\char`_ptr}}
    \href{https://en.cppreference.com/w/cpp/memory/unique_ptr}{cppreference documentation} 
    about \textbf{\texttt{std::unique\char`_ptr}}.
    \newline
...
\nparagraph{Single-object versioin, \texttt{unique\char`_ptr}}
\vspace{-8truemm}
\begin{table}[ht]
    \begin{tabular}{|l|l|}
        \cline{1-2}
...
\subsubsection{\texttt{std::shared\char`_ptr}}
    \href{https://en.cppreference.com/w/cpp/memory/shared_ptr}{cppreference documentation} 
    about \textbf{\texttt{std::shared\char`_ptr}}.
    \newline
...
\subsubsection{\texttt{std::weak\char`_ptr}}
    \href{https://en.cppreference.com/w/cpp/memory/weak_ptr}{cppreference documentation} 
    about \textbf{\texttt{std::weak\char`_ptr}}.
    \newline
...
\newpage
\subsubsection{\texttt{std::auto\char`_ptr}}
    \href{https://en.cppreference.com/w/cpp/memory/auto_ptr}{cppreference documentation} 
    about \textbf{\texttt{std::auto\char`_ptr}}.
    \newline
