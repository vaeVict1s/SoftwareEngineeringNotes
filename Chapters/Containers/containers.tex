...
\nparagraph{Decision Charts}
\begin{figure}
\includegraphics[scale=0.5]{Containers/sequence_and_ordered_containers_decision_chart}
\caption{Decision Chart: Sequence And Ordered Containers}
\label{fig:}
\end{figure}

\begin{figure}    
\includegraphics[scale=0.5]{Containers/adaptative_and_unordered_containers_decision_chart}
\caption{Decision Chart: Adaptative And Unordered Containers}
\label{fig:}
\end{figure}
