...
\begin{table}[h]
    \begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \href{https://en.cppreference.com/w/cpp/container/set}{set} & \highlightit{collection of unique keys}, sorted by keys \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/map}{map} & \highlightit{collection of key-value pairs}, sorted by keys, keys are unique \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/multiset}{multiset} & \highlightit{collection of keys}, sorted by keys \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/multimap}{multimap} & \highlightit{collection of key-value} pairs, sorted by keys \\
    \hline
    \end{tabularx}
\end{table}
...
\begin{table}[h]
    \begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \href{https://en.cppreference.com/w/cpp/container/unordered_set}{unordered\char`_set} & collection of unique keys, hashed by keys \\        
    \hline
    \href{https://en.cppreference.com/w/cpp/container/unordered_map}{unordered\char`_map} & collection of key-value pairs, hashed by keys, keys are unique \\        
    \hline
    \href{https://en.cppreference.com/w/cpp/container/unordered_multiset}{unordered\char`_multiset} & collection of keys, hashed by keys \\        
    \hline
    \href{https://en.cppreference.com/w/cpp/container/unordered_multimap}{unordered\char`_multimap} & collection of key-value pairs, hashed by keys \\        
    \hline
    \end{tabularx}
\end{table}
...
\begin{table}[h]
    \begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \href{https://en.cppreference.com/w/cpp/container/stack}{stack} & adapts a container to provide stack (LIFO data structure) \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/queue}{queue} & adapts a container to provide queue (FIFO data structure) \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/priority_queue}{priority\char`_queue} & adapts a container to provide priority queue \\
    \hline
    \end{tabularx}
\end{table}
...
\begin{table}[h]
    \begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \href{https://en.cppreference.com/w/cpp/container/flat_set}{flat\char`_set} & adapts a container to provide a collection of unique keys, sorted by keys \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/flat_map}{flat\char`_map} & adapts two containers to provide a collection of key-value pairs, sorted by unique keys \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/flat_multiset}{flat\char`_multiset} & adapts a container to provide a collection of keys, sorted by keys \\
    \hline
    \href{https://en.cppreference.com/w/cpp/container/flat_multimap}{flat\char`_multimap} & adapts two containers to provide a collection of key-value pairs, sorted by keys \\
    \hline
    \end{tabularx}
\end{table}
