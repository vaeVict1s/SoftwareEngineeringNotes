...
\begin{enumerate}
    \item \textbf{Sections~\ref{sec:quant-dev-role}--\ref{sec:crypto-markets}:} 
          Role, lifecycle, market structure, instruments, spot/futures infra, 
          and a compact crypto markets map.
...
\noindent\textit{Roadmap (markets expansion):} complex derivatives systems notes (D) and 
microstructure polish (F) remain; deep order-book layout stays in 
