...
\begin{enumerate}
    \item \textbf{Section~\ref{sec:quant-dev-role},~\ref{sec:trade-lifecycle},
          and~\ref{sec:market-structure}:} 
          Role, trade lifecycle, and market structure (who trades where).
...
\newline
\noindent\textit{Roadmap (markets expansion):} instruments (B), spot/futures infrastructure (C), 
...
Market structure (A) is Section~\ref{sec:market-structure}.
