    ...
    \begin{table}[h!t]
        \begin{center}
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \texttt{\href{https://en.cppreference.com/w/c/memory/malloc}{malloc}} & \\
                \hline
                \texttt{\href{https://en.cppreference.com/w/c/memory/free}{free}} & \\
                \hline
            \end{tabularx}
        \end{center}
    \end{table}
...
\subsection{Memory Allocation and Deallocation in C++}
    \begin{table}[h!t]
        \begin{center}
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \href{https://en.cppreference.com/w/cpp/language/new}{new expression} & \\
                \hline
                \href{https://en.cppreference.com/w/cpp/language/delete}{delete expression} & \\
                \hline
            \end{tabularx}
        \end{center}
    \end{table}
