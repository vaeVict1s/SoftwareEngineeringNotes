...
\documentclass[12pt,hidelinks]{book}
    ...
    \addbibresource{./Chapters/Bibliography/quantbasics.bib}
    \addbibresource{./Chapters/Bibliography/algorithms.bib}
    \addbibresource{./Chapters/Bibliography/dsapatterns.bib}
...
\newpage
\printbibsection{subbibintoc}{quantbasics}{Quant Basics for Developers Bibliography}
\part{Algorithms}
...
\newpage
\printbibsection{subbibintoc}{dsapatterns}{Algorithmic Patterns Bibliography}
