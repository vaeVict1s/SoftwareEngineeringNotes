...
\lstdefinestyle{mystyle}{
    ...
    emph={bool,char,short,int,long,float,double,void,unsigned,signed,const,volatile,auto,
          ...
          cpu_set_t,sched_param,pthread_t,sockaddr,sockaddr_in,epoll_event,pollfd,fd_set,timeval,off_t,enable_if_t,remove_reference_t,is_same_v,integer_sequence,
